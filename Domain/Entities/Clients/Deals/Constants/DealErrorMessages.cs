namespace Jantzch.Server2.Domain.Entities.Clients.Deals.Constants;

public static class DealErrorMessages
{
    public const string NOT_FOUND = "Negócio não encontrado";
